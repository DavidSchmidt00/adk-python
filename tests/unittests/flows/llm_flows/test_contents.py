...
from google.adk.flows.llm_flows.contents import _convert_event_from_user_perspective
...
def test_convert_event_from_user_perspective():
  """Test _convert_event_from_user_perspective function."""
  agent_event = Event(
      invocation_id="test_inv",
      author="agent1",
      content=types.Content(
  ...
  converted_event = _convert_event_from_user_perspective(agent_event)
...
def test_convert_event_with_function_call():
  """Test _convert_event_from_user_perspective with function call."""
...
def test_convert_event_with_function_response():
  """Test _convert_event_from_user_perspective with function response."""
